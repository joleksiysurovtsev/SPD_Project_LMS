...
//    private List<Lecture> lectures = ParserLecturesJSON.parseLecturesFromJSON();
//
//            new ArrayList<>() {
//        {
...
//    };
    ...
    public void setAll(List<Lecture> lectures) throws IOException {
        ParserLecturesJSON.parseLecturesInJSON(lectures);    //    this.lectures = lectures;
    }

    @Override
    public void addLecture(Lecture lecture) throws IOException {
        List<Lecture> lectures = getAll();
        lectures.add(lecture);
        setAll(lectures);
    }

    @Override
    public void removeLecture(int id) throws IOException {
        List<Lecture> lectures = getAll();
