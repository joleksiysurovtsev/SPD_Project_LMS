    ...
    private List<Lecture> lectures = new ArrayList<>() {
        {
            ...
            add(new LectureIModel(LectureType.JAVA_CONCURRENCY, 19, "\"Concurrency (part 1)\"", new ArrayList<>(), "	Mykola Popadyk	", new GregorianCalendar(2020, 11, 7), 18));
            ...
            add(new LectureIModel(LectureType.JAVA_CONCURRENCY, 21, "\"Concurrency (part 2)\"", new ArrayList<>(), "	Mykola Popadyk	", new GregorianCalendar(2020, 11, 14), 19));
            add(new LectureIModel(LectureType.DB, 22, "\"JDBC\"", new ArrayList<>(), "	Ruslan Pistriak	", new GregorianCalendar(2020, 11, 16)));
            add(new LectureIModel(LectureType.JAVA_CONCURRENCY, 23, "\"Concurrency (part 3)\"", new ArrayList<>(), "	Mykola Popadyk	", new GregorianCalendar(2020, 11, 21), 20));
