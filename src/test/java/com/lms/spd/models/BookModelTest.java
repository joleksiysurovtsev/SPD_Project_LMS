...
class BookModelTest {
    ...
    void print() {
        ...
        assertEquals(" Book: Философия Java Author: Брюс Эккель Genre: " +
                "Computer Science Publishing in: 2015year\t Date the resource was added: "
                + sdf.format(testBook.getDateResourceWasAdded().getTime()) + " ID 0", testBook.print());
    }
